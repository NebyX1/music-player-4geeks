...
// Esta función está vinculada al botón "previo" y permite cambiar a la canción anterior, a menos que se esté posicionado en el último elemento y entonces lo que hace es ir al último elemento mediante un if condicional que evita restarle -1 a 0, lo cual devolvería un error
    const playPrevious = () => {
      for (let i = 0; i < music.length; i++) {
        let a = i
        a = a - 1
